...
<head>
    ...
    <title>도박 범죄 유형별 증감율 예측 | 도박 중독 개선 서비스</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/predictive2.css">
    <style>
...
<body>
    <div id="container">
        ...
        <form id="signup" name="signup" method="post" action="/predictive2Result.do">
        <div id="mainMenu">
            <h3>
                조건을 선택하여 사이버 도박 유형별 증감을 예측 분석하는 서비스입니다. 
            </h3>
            <div id="form">
            <p>
                조건을 선택해주세요.
            ...
            <ul>
                <li>
                    <label class="sub-title">Q1. <span>도박 유형</span></label>
                    <div class="info">
                        <label><input id="toto" name="toto" type="checkbox" value="toto">불법 스포츠토토</label>
                        <label><input id="horse" name="horse" type="checkbox" value="horse">불법 경마</label><br>
                        <label><input id="casino" name="casino" type="checkbox" value="casino">불법 카지노</label><br>
                        <label><input id="othergame" name="othergame" type="checkbox" value="othergame">기타 사이버 도박(사다리/홀짝)</label><br>
                    </div>
                </li>
                <li>
