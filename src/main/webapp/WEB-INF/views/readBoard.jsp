...
<script type="text/javascript">
     ...
     function list2()
     {
    	 location.href='/freeBoard?pageNumber=1';
     }
    ...
    <div id="box">
        ...
        <div id="write">
			...
			<c:choose> 
				...
				<c:when test="${user_id.equals('admin')}">
					<div id="login_service">
            			<input type="button" onclick="list2()" value ="목록으로">
            			<input type="button" onclick="del()" value ="삭제하기">
            		</div>
			...
			<c:forEach var="reply" items="${reply}">
        			...
        			<div id="reply">
				 	...
				 	<c:choose>
						...
						<div id="replyEdit">
					    	...
					    	<span id="test"><input type="button" onclick="window.open('/editreplyPage.do?reply_number=${reply.getReply_number()}&write_number=${reply.getWrite_number()}', 'new', 'width=500, height=200, top=10, left=10');" value="댓글 수정"></span>
					   		...
					   		<script type="text/javascript">
					   			function delreply() 
					   			{
					   				if(confirm("댓글을 삭제하시겠습니까?"))
					   	    	 	{
					   	    		 location.href='/deletereply.do?reply_number=${reply.getReply_number()}&write_number=${reply.getWrite_number()}';
					   	    	 	}   
								}
					   		</script>
				...
				<c:otherwise>
					<div id ="com">
            			...
            			<input id="write_number" name="write_number" type="hidden" value="${readBoard.getWrite_number()}">
