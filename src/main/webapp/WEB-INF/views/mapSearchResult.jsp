...
var listData = new Array();
	...
	address:listData.push("${address.getaDDRESS}");
	category:listData.push("${address.getcENTER_NAME}");
...
<div id="result">
        		<tr>
        			<br><td><h4>센터명 : <c:out value="${address.getCENTER_NAME}"/></h4></td>
        			<td><h4>우편번호 : <c:out value="${address.getPOSTAL_CODE}"/></h4></td>
        			<td><h4>주소 : <c:out value="${address.getADDRESS}" /><c:out value="${address.getADDRESS2}" /></h4></td>
        			<td><h4>전화번호 : <c:out value="${address.getNUMBER1} "/><c:out value="${address.getNUMBER2}"/><c:out value="${address.getNUMBER3}"/></h4></td>
        			<td><h4>팩스번호 : <c:out value="${address.getFAX1} "/><c:out value="${address.getFAX2}"/><c:out value="${address.getFAX3}"/></h4></td>
        			<td><c:out value="${address.getURL}"/></td><br>
        		</tr>
</div>
   </div>
      <footer>
