...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/selfTestResult.css">
    <style>
...
<li class="checkup-list__title">
	<h2><span style="color:#eee; font-size: 27px;">문항</span></h2>
</li>
<li>
...
<p><a class="btn" href="#result"></a></p>
<div id="result" class="modal">

	<c:if test="${result >= 8}">
	<h2>당신의 점수는 ${result}점이며,<br> 도박 중독 <span class="c1">심각</span>단계로 의심됩니다.</h2>
	<div id="modal_box">
	</div>
	<div id="center"><a href="#" onclick="location.href='/map';">가까운 도박중독 관리센터 찾아보기</a></div>
	</c:if>
	
	<c:if test="${result <= 3}">
	<h2>당신의 점수는 ${result}점이며,<br> 도박 중독에서 <span class="c1">안전한 상태</span>입니다.</h2>
	<div id="modal_box2">
	</div>
	<div id="center"><a href="#" onclick="location.href='/map';">가까운 도박중독 관리센터 찾아보기</a></div>
	</c:if>

	<c:if test="${result >= 4 && result <= 7}">
	<h2>당신의 점수는 ${result}점이며,<br> 도박 중독 <span class="c1">주의</span>단계로 의심됩니다.</h2>
	<div id="modal_box3">
	</div>
	<div id="center"><a href="#" onclick="location.href='/map';">가까운 도박중독 관리센터 찾아보기</a></div>
	</c:if>
