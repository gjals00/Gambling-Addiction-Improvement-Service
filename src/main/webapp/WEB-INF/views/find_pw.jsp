...
<head>
    ...
    <title>비밀번호 찾기 | 도박 중독 개선 서비스</title>
...
<body>
    ...
    <h1>비밀번호 찾기</h1>
        ...
        <form id="signup" method="post" action="/findPw.do">
              ...
              <ul>
                ...
                <li>
                  ...
                  <input id="user_id" name="user_id" type="text" required autofocus>
                </li>
                <li>
                ...
                <div id="find">
                <!--<p>이메일로 임시 비밀번호를 발송해드립니다.</p>-->
                </div>
              </ul>
              <br>
              <br>
              <input type="submit" value="비밀번호 찾기" style="width: 300px; height: 70px"> 
              <div id="login_menu">
              <ul>
                <br>
